...
import com.allsouls.newsapp.tracking.data.toMap
...
class TrackingAdaptersTest {
    ...
    @Test
    fun `returns params map when converting network request event`() {
        val time = 100
    ...
    @Test
    fun `returns params map when converting display screen event`() {
        val screen = "xxx"
